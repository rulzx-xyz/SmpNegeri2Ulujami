            ...
            <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    <AnimatedWrapper animationType="slide-right" className="lg:w-1/2">
                        <div className="text-gray-700 space-y-4 text-lg leading-relaxed max-w-prose">
                            ...
                            <p className="font-semibold text-primary">Misi kami adalah "Menciptakan Pelajar Berakhlak Malia, Berkarakter, Mengembangkan Kecerdasan Intelektual Siswa, Mendorong Siswa Untuk Menjadi Mandiri".</p>
