        ...
        <header className="bg-gradient-to-r from-primary to-blue-700 text-white p-3 sm:p-4 sticky top-0 z-40 shadow-lg">
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex items-center space-x-3 sm:space-x-4">
                    <img src="https://files.catbox.moe/bpm0z2.jpg" alt="Logo SMP Negeri 2 Ulujami" className="h-12 sm:h-14 w-auto" />
                    <div>
                        <h1 className="text-base sm:text-lg md:text-xl font-bold leading-tight">SMP NEGERI 2 ULUJAMI</h1>
                        <span className="text-xs sm:text-sm opacity-90">Pemalang, Ulujami Jawa Tengah</span>
                    </div>
                </div>
