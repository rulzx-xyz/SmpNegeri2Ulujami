            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                <div className={`flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 load-in-item ${loaded ? 'end' : 'start'}`} style={{ transitionDelay: '500ms' }}>
                    <button 
                        ...
                        className="bg-accent text-white font-bold py-3 px-8 rounded-full text-base md:text-lg hover:bg-yellow-600 transition-transform transform hover:scale-105 duration-300 shadow-lg cursor-pointer"
                    >
                        Tentang Kami
                    </button>
                    <button
                        onClick={() => handleScrollTo('contact')}
                        className="bg-transparent border-2 border-white text-white font-bold py-3 px-8 rounded-full text-base md:text-lg hover:bg-white hover:text-primary transition-all duration-300 shadow-lg cursor-pointer"
                    >
                        Hubungi Kami
                    </button>
                </div>
