    ...
    return (
        ...
        >
            ...
            >
                <button
                    onClick={onClose}
                    className="absolute -top-4 -right-4 w-10 h-10 bg-white rounded-full text-primary text-2xl flex items-center justify-center shadow-lg hover:bg-gray-200 transition-colors z-10"
