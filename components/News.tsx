...
const newsData = [
    {
        ...
        date: "Tahun  2024",
        title: "Meraih Kemenangan Yang Sangat Luar Biasa Juara 1 Piala Bupati Pemalang, Marching Band Tahun",
    ...
    },
    {
        ...
        date: "22 Juni 2025",
        title: "Siswa SMP Negeri 2 Ulujami Raih Juara 2 Suppoerter Terbaik Dan Juara 3 Best Costume",
        excerpt: "Prestasi Sangat membanggakan diraih SMP Negeri 2 Ulujami, Meraih Juara 1 Suppoerter Terbaik Dan Juara 3 Best Costume."
    }
];

const NewsCard: React.FC<NewsCardProps> = ({ imgSrc, date, title, excerpt }) => (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col h-full group">
